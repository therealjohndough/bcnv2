...
class BCN_Admin_Theme {
    ...
    public function enqueue_admin_scripts($hook) {
        ...
        // Enqueue admin CSS
        $this->enqueue_admin_style('bcn-admin-main', 'css/admin-main.css', array(), $version);
        $this->enqueue_admin_style('bcn-admin-components', 'css/admin-components.css', array('bcn-admin-main'), $version);
        $this->enqueue_admin_style('bcn-admin-forms', 'css/admin-forms.css', array('bcn-admin-main'), $version);
        $this->enqueue_admin_style('bcn-admin-responsive', 'css/admin-responsive.css', array('bcn-admin-main'), $version);

        // Enqueue admin JavaScript
        $this->enqueue_admin_script('bcn-admin-main', 'js/admin-main.js', array('jquery'), $version, true);
        $this->enqueue_admin_script('bcn-admin-forms', 'js/admin-forms.js', array('jquery', 'bcn-admin-main'), $version, true);
        $this->enqueue_admin_script('bcn-admin-dashboard', 'js/admin-dashboard.js', array('jquery', 'bcn-admin-main'), $version, true);
        $this->enqueue_admin_script('bcn-admin-automation', 'js/admin-automation.js', array('jquery', 'bcn-admin-main'), $version, true);
    ...
    private function enqueue_admin_style($handle, $relative_path, $deps = array(), $version = null) {
        $full_path = get_template_directory() . '/admin-theme/assets/' . $relative_path;
        ...
        wp_enqueue_style(
            $handle,
            get_template_directory_uri() . '/admin-theme/assets/' . $relative_path,
            $deps,
            $version
        );
    }

    private function enqueue_admin_script($handle, $relative_path, $deps = array(), $version = null, $in_footer = false) {
        $full_path = get_template_directory() . '/admin-theme/assets/' . $relative_path;
